...
# @Time : 2021/11/30 13:44
# @Auth: GLK
# @File: test_convenient_access.py
# @Software :PyCharm

import unittest
from api.Convenient_access_api import Convenient_Access_Api
...
mylogger = Logger(logger="Test_Convenient_Access_Api").getlog()
path = BASE_DIR + "/database/Convenient_access.xlsx"
actual_code_list = []
actual_status_list = []
result_list = []


class Test_Convenient_Access_Api(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        mylogger.info("开始测试Test_Convenient_Access_Api")
        cls.convenient_access_api = Convenient_Access_Api()
    ...
    def tearDownClass(cls) -> None:
        ...
        mylogger.info("结束测试Test_Convenient_Access_Api")
    ...
    def test_convenient_access_api(self, case_name, api, params, headers, method, expect_code, status_code):
        ...
        response = self.convenient_access_api.convenient_access_api(url=url, params=params, headers=headers,
                                                                    method=method)
